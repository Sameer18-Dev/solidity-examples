...
describe("Getting Started with Solidity / Data Types / MyContract", function () {
  let contract;

  beforeEach(async () => {
    const Contract = await ethers.getContractFactory(
      "contracts/getting_started_with_solidity/01_data_types/01_MyContract.sol:MyContract"
    );
